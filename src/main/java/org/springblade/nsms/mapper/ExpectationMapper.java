...
public interface ExpectationMapper extends BaseMapper<Expectation> {
	 ...
	 * @return
	 */
	List<ExpectationVO> selectExpectationPage(IPage page, ExpectationVO expectation);

	Integer getPriority(String referenceSid,String userId);
}

...
/**
 * 人员安排表，排班表包装类,返回视图层所需的字段
 *
 * @author Blade
 * @since 2022-04-18
 */
public class StaffTimeWrapper extends BaseEntityWrapper<StaffTime, StaffTimeVO>  {

    public static StaffTimeWrapper build() {
        return new StaffTimeWrapper();
    }

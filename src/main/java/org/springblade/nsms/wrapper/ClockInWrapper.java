 ...
 * @since 2022-04-11
 */
public class ClockInWrapper extends BaseEntityWrapper<ClockIn, ClockInVO>  {
	...
	@Override
	public ClockInVO entityVO(ClockIn clockIn) {
		ClockInVO clockInVO = BeanUtil.copy(clockIn, ClockInVO.class);

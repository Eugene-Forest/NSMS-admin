 ...
 * @since 2022-04-18
 */
public interface IExpectationService extends FoundationService<Expectation> {
	 ...
	 * @return
	 */
	IPage<ExpectationVO> selectExpectationPage(IPage<ExpectationVO> page, ExpectationVO expectation);
